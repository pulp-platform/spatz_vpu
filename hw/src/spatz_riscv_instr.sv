...
package spatz_riscv_instr;
  ...
  localparam [31:0] PACE_AH            = 32'b011001000000?????????????1010011;
  localparam [31:0] PACE_H             = 32'b011000100000?????????????1010011;
  localparam [31:0] PACE_S             = 32'b011000000000?????????????1010011;
  ...
  localparam [31:0] VPACE_AH           = 32'b1110?????????????010?????0110011;
  localparam [31:0] VPACE_H            = 32'b1110?????????????001?????0110011;
  localparam [31:0] VPACE_S            = 32'b1110?????????????000?????0110011;
