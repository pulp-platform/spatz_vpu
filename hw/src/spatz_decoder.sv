        ...
        spatz_riscv_instr::VSLIDE1DOWN_VX: begin
          ...
          unique casez (decoder_req_i.instr)
            ...
            spatz_riscv_instr::VMV_V_I: begin
              ...
              // vmv.v.v reads its source vector from the vs1-encoded field,
              // which we remap into vs2 for the single-read-port VSLDU.
              spatz_req.use_vs2            = decoder_req_i.instr inside {spatz_riscv_instr::VMV_V_V};
...
`ifdef VENTAGLIO
              spatz_riscv_instr::VFXMUL_VF: begin
                spatz_req.op = VFMUL;
...
`ifdef VENTAGLIO
              spatz_riscv_instr::VFXMACC_VF: begin
                spatz_req.op                 = VFMADD;
                spatz_req.vd_is_src          = 1'b1;
                spatz_req.op_vtl.use_vtl     = 1'b1;
...
`ifdef VENTAGLIO
        spatz_riscv_instr::VFXMACC_VRF: begin
        ...
        spatz_riscv_instr::VFXMUL_VRF: begin
          automatic vreg_t       vd_field  = decoder_req_i.instr[11:7];
        ...
        spatz_riscv_instr::VVENTCLR: begin
          automatic logic [1:0] funct2 = decoder_req_i.instr[26:25];
...
`endif // VENTAGLIO
        ...
        spatz_riscv_instr::CSRRCI: begin
          ...
          case (csr_addr)
            ...
            spatz_riscv_instr::CSR_VCSR,
            spatz_riscv_instr::CSR_VTLREG,
            spatz_riscv_instr::CSR_VTLIDXW,
            spatz_riscv_instr::CSR_VTLBLKS,
            spatz_riscv_instr::CSR_VTLRATIO: begin
          ...
          unique casez (decoder_req_i.instr)
            spatz_riscv_instr::CSRRW,
            spatz_riscv_instr::CSRRWI: begin
              ...
              if (csr_addr == spatz_riscv_instr::CSR_VTLREG) begin
                spatz_req.use_rd              = csr_rd != '0;
                spatz_req.op_cfg.vtl_redirect = 1'b1;
              end

              if (csr_addr == spatz_riscv_instr::CSR_VTLIDXW) begin
                spatz_req.use_rd                     = csr_rd != '0;
                spatz_req.op_cfg.set_vtl_index_width = 1'b1;
              end

              if (csr_addr == spatz_riscv_instr::CSR_VTLBLKS) begin
                spatz_req.use_rd                  = csr_rd != '0;
                spatz_req.op_cfg.set_vtl_blk_size = 1'b1;
              end

              if (csr_addr == spatz_riscv_instr::CSR_VTLRATIO) begin
                spatz_req.use_rd               = csr_rd != '0;
